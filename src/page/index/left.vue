		...
		<div class="leftMenu">
			<Menu :theme="theme3" active-name="1" width='190px' border-right='0px'>
				<MenuGroup>
					...
					<MenuItem name="4">
						<div class="menuCon"  @click="goCollect">
							<span >周汇总</span>
						</div>
					</MenuItem>
					<MenuItem name="1">
					...
					<MenuItem name="6">
						<a href="http://192.168.1.200:10000/#/index" target="_blank">
							<div class="menuCon">
					...
					<MenuItem name="7">
						<a href="http://192.168.1.200:8000/index.php/login" target="_blank">
							<div class="menuCon">
					...
					<MenuItem name="3">
						<a href="http://qingjia.7dugo.com" target="_blank">
							<div class="menuCon">
							<!--<em class="MenuIcon iconYunpan"></em>-->
								请假
							</div>
